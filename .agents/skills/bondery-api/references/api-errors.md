...
- `check-route-errors` — inside `pnpm run check:types -w api`
- `pnpm run check:api-errors` — `check-api-errors-catalog`, `check-api-errors-translations`, `check-api-errors-client-display` (repo root)
