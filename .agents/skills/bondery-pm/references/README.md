...
| [release-handoff.md](release-handoff.md) | Release queue → Released with changelog |
| [agent-workflows.md](agent-workflows.md) | MCP sequences: create, groom, stale detect |
| [migration-heuristics.md](migration-heuristics.md) | One-time bulk migration rules (audit trail) |

Public roadmap: [bondery-roadmap](../../bondery-roadmap/SKILL.md). Release: [bondery-release](../../bondery-release/SKILL.md).
