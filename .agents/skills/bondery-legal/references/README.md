...
| [self-host-vs-cloud.md](./self-host-vs-cloud.md) | Data controller split for self-hosters |
| [escalation-boundaries.md](./escalation-boundaries.md) | Agent may draft vs. must escalate |
| [long-term-roadmap.md](./long-term-roadmap.md) | Manifest, CI drift, compliance evolution |
