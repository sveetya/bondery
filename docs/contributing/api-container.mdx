...
Local laptop Redis: [`deploy/bondery/docker-compose.dev-redis.yml`](../../deploy/bondery/docker-compose.dev-redis.yml) (`npm run start:redis`, port 26636) — not the production `deploy/bondery` stack.
