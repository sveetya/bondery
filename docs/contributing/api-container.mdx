...
<Callout type="info">
**Bondery production / advanced operators** — self-hosters use the unified [`deploy/bondery`](../../deploy/bondery/) stack (webapp + API + Redis + Postgres). See [Self-hosting](../deploy/get-started.mdx).
</Callout>
