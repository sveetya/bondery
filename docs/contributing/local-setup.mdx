...
Required secrets include `BONDERY_PRIVATE_BETTER_AUTH_SECRET` (≥32 characters) and `BONDERY_PRIVATE_API_KEY_PEPPER` — see [API keys](#api-keys-long-lived-integration-tokens) below.
