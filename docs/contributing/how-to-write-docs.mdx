...
1. **Title** — frontmatter `title` (rendered by the docs site) plus matching `#` heading in the body when useful for GitHub readers
...
- **Navigation** — update the nearest `meta.json` whenever you add, move, or rename a page
