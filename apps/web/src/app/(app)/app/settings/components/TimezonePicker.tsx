...
>(
  (
    { label, flag, offset, isSelected, currentlySelectedText, ...others },
    ref
  ) => {
    ...
    return (
      ...
      >
        <div style={{ display: "flex", gap: 8, alignItems: "center", flex: 1 }}>
          <span
            className={`fi fi-${flag || "aq"}`}
            style={{ width: 20, flexShrink: 0 }}
          />
          <div style={{ flex: 1 }}>
            {isSelected && (
              <Text component="span" c="white" size="sm" mr={4} fw={700}>
    ...
    <Stack gap={4}>
      ...
      <Combobox store={combobox} onOptionSubmit={handleChange}>
            ...
            {selectedTimezone ? (
              ...
              >
                ...
                <Text size="sm" truncate style={{ flex: 1 }} fw={700}>
                  ...
                  <Text component="span" c="white" size="xs" fw={400}>
        ...
        <Combobox.Dropdown
          styles={{
            dropdown: {
              "--combobox-option-active-bg":
                "var(--mantine-color-branding-primary-filled-hover)",
            },
          }}
        >
          <Combobox.Search
