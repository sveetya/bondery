...
export function ProviderIntegrations({
      ...
      notifications.show({
        ...
        message:
          error instanceof Error
            ? error.message
            : tIntegration("LinkError", { provider }),
        color: "red",
      });
    }
  };
    ...
    try {
      ...
      notifications.show({
        ...
        message:
          error instanceof Error
            ? error.message
            : tIntegration("UnlinkError", { provider }),
        color: "red",
      });
    }
  };
  ...
  return (
    <Stack gap="sm">
      ...
      <Group gap="md">
        {INTEGRATION_PROVIDERS.map(
          ({ provider, providerKey, displayName, iconColor }) => {
            const icon =
              provider === "github" ? IconBrandGithub : IconBrandLinkedin;
